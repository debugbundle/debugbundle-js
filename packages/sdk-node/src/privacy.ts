...
/** Preserve protocol identifiers and transport auth while protecting captured application data. */
export function protectNodeEvent(event: EventEnvelope, additionalKeys: readonly string[]): EventEnvelope | null {
